...
def run_sjf(processes: List[Any]) -> Tuple[List[Any], List[Dict[str, Any]], int]:
    """
    Shortest Job First (SJF) non-preemptive algoritmasını çalıştırır.
    """
    ...
    while len(completed_processes) < len(sim_processes):
        ...
        if ready_queue:
            # SJF Kuralı: Hazır kuyruktaki en kısa Burst süreli süreci seç.
            ...
            # Context switch non-preemptive için genellikle 0'dır, ancak süreçler arasında geçiş yapılır.
            
            # 3. Süreci Çalıştırma (Non-preemptive olduğu için tamamlanana kadar çalışır)
            ...
            # IDLE Durumu: Eğer kuyruk boşsa, zamanı bir sonraki varış anına ilerlet.
            ...
            if remaining:
                ...
                break # Tüm süreçler bitti

    # Context Switch Sayısını Hesapla (Non-IDLE bloklar arası geçiş)
